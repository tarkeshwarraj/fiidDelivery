        ...
        try{
            ...
            if(paymentOption === "COD"){
                const {data} = await axios.post('/api/order/cod',{
                    ...
                    userId: user._id,
                    items: cartArray.map(item => ({products: item._id, quantity: item.quantity})),
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddress ? `${selectedAddress.street}, ${selectedAddress.city}, ${selectedAddress.city}, ${selectedAddress.country}` : "No address found"}</p>
